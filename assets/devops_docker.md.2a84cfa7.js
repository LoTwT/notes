...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="build-deploy" tabindex="-1">build:deploy <a class="header-anchor" href="#build-deploy" aria-hidden="true">#</a></h3><p><code>build:deploy</code> \u662F\u5B9A\u4E49\u5728 <code>package.json</code> \u4E2D\uFF0C\u4F7F\u7528 <code>vite build</code> \u6784\u5EFA\uFF0C\u8FD0\u884C\u81EA\u5B9A\u4E49\u811A\u672C\u6587\u4EF6\uFF0C\u4EE5\u8FBE\u5230\u751F\u6210\u9700\u8981\u7684 <code>deploy</code> \u6587\u4EF6\u5939\u7684\u547D\u4EE4</p><div class="language-shell"><span class="copy"></span><pre><code><span class="line"><span style="color:#676E95;font-style:italic;"># deploy \u6587\u4EF6\u5939\u7684\u5927\u81F4\u7ED3\u6784</span></span>
...
<span class="line"></span></code></pre></div><div class="language-json"><span class="copy"></span><pre><code><span class="line"><span style="color:#89DDFF;">{</span></span>
...
<span class="line"></span></code></pre></div><p>\u4EE5\u4E0B\u662F <code>buildDeploy.js</code> \u811A\u672C\u7684\u5185\u5BB9</p><p>\u56E0\u4E3A\u7528\u5230\u4E86 <code>fs.cpSync</code>\uFF0C\u9700\u8981 <code>node &gt;= 16.7.0</code> \u54E6</p><div class="language-javascript"><span class="copy"></span><pre><code><span class="line"><span style="color:#C792EA;">const</span><span style="color:#A6ACCD;"> fs </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> </span><span style="color:#82AAFF;">require</span><span style="color:#A6ACCD;">(</span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">fs</span><span style="color:#89DDFF;">&quot;</span><span style="color:#A6ACCD;">)</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#89DDFF;font-style:italic;">if</span><span style="color:#A6ACCD;"> (fs</span><span style="color:#89DDFF;">.</span><span style="color:#82AAFF;">existsSync</span><span style="color:#A6ACCD;">(deployDir)) </span><span style="color:#89DDFF;">{</span></span>
...
<span class="line"></span></code></pre></div><h2 id="node" tabindex="-1">node <a class="header-anchor" href="#node" aria-hidden="true">#</a></h2><p>\u4EE5 <a href="https://www.eggjs.org/" target="_blank" rel="noopener noreferrer">eggjs</a> \u4E3A\u4F8B</p><p>\u6D41\u7A0B\u4E0E\u90E8\u7F72 web \u9879\u76EE\u5927\u81F4\u76F8\u540C\uFF0C\u6838\u5FC3\u662F\u914D\u7F6E Dockerfile\uFF0C\u4F46\u9700\u8981\u6CE8\u610F\u7684\u662F\uFF1A</p><ol><li>node \u9879\u76EE\u76F4\u63A5\u5C06\u9879\u76EE\u76EE\u5F55\u4E0A\u4F20\u5230\u670D\u52A1\u5668\u5373\u53EF</li><li>\u5EFA\u8BAE\u4ECE\u4EE3\u7801\u4ED3\u5E93\u62C9\u53D6\u7EAF\u51C0\u7684\u9879\u76EE\u4E0A\u4F20</li><li>\u9879\u76EE\u4F9D\u8D56\u7684 <code>node_modules</code> \u53EF\u6839\u636E\u60C5\u51B5\uFF0C\u9009\u62E9\u5408\u9002\u7684\u65F6\u673A\u5B89\u88C5\uFF0C\u793A\u4F8B\u653E\u5728\u4E86 Dockerfile \u4E2D</li><li>\u542F\u52A8\u627F\u8F7D node \u670D\u52A1\u7684\u5BB9\u5668\u65F6\uFF0C\u6709\u53EF\u80FD\u9700\u8981\u66F4\u9AD8\u7684\u6743\u9650 <code>--privileged=true</code></li></ol><p>\u4E00\u4E2A\u53EF\u80FD\u7684\u542F\u52A8\u5BB9\u5668\u547D\u4EE4 <code>docker run -it -p 7001:7001 -d --privileged=true --name container-name image-name</code></p><h3 id="dockerfile-1" tabindex="-1">Dockerfile <a class="header-anchor" href="#dockerfile-1" aria-hidden="true">#</a></h3><div class="language-"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;"># \u8BBE\u7F6E\u57FA\u7840\u955C\u50CF\uFF0C\u5982\u679C\u672C\u5730\u6CA1\u6709\u8BE5\u955C\u50CF\uFF0C\u4F1A\u4ECE\u670D\u52A1\u5668\u62C9\u53D6</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,33),e=[o];function c(r,t,i,A,C,D){return a(),n("div",null,e)}var F=s(p,[["render",c]]);export{d as __pageData,F as default};
